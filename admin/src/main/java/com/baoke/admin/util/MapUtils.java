...
public class MapUtils extends org.apache.commons.collections.MapUtils {  
    ...
    public static <T, V> T toObject(Class<T> clazz, Map<String, V> map) throws InstantiationException, IllegalAccessException, InvocationTargetException {  
        return toObject(clazz.newInstance(), map);  
    }  
     ...
     * @throws InvocationTargetException 
     */  
    public static <T, V> T toObject(Class<T> clazz, Map<String, V> map, boolean toCamelCase, String dateFormatStr) throws InstantiationException, IllegalAccessException, InvocationTargetException {  
        return toObject(clazz.newInstance(), map, toCamelCase, dateFormatStr);  
    }  
    ...
    public static <T, V> T toObject(T object, Map<String, V> map) throws InstantiationException, IllegalAccessException, InvocationTargetException {  
        return toObject(object, map, false, null);  
    }  
  
    public static <T, V> T toObject(T object, Map<String, V> map, boolean toCamelCase, String dateFormatStr) throws InstantiationException, IllegalAccessException, InvocationTargetException {  
		if (StringUtils.isNotBlank(dateFormatStr)) {
    		ConvertUtils.register(new DateLocaleConverter(Locale.CHINESE, dateFormatStr), Date.class);
    	}
        if (toCamelCase)  
