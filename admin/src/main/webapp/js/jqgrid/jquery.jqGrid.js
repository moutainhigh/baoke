(function(a) {
    ...
    a.extend(a.jgrid, {
        ...
        format: function(d) {
            ...
            if (d === undefined) d = "";
            return d.replace(/\{(\d+)\}/g, function(c, f) {
                return e[f];
            });
        },
        ...
        parseDate: function(d, e) {
            ...
            if (e && e !== null && e !== undefined) {
                ...
                f = c.y;
                if (f >= 70 && f <= 99) c.y = 1900 + c.y; else if (f >= 0 && f <= 69) c.y = 2e3 + c.y;
            }
        ...
        from: function(d) {
            return new function(e, c) {
                ...
                this.startsWith = function(q, r) {
                    ...
                    if (v) f._append(f._getStr("jQuery.jgrid.getAccessor(this,'" + q + "')") + ".substr(0," + s + ") == " + f._getStr('"' + f._toStr(r) + '"')); else {
    ...
    a.fn.jqGrid = function(d) {
        ...
        return this.each(function() {
            if (!this.grid) {
                var f = a.extend(true, {
                    ...
                    dragMove: function(u) {
                        if (this.resizing) {
                            ...
                            var w = f.direction === "ltr" ? u.width + t : u.width - t, z;
                            if (w > 33) {
                                this.curGbox.css({
                    ...
                    populateVisible: function() {
                        ...
                        if (u) {
                            ...
                            if (z) {
                                ...
                                if (O) if (!(f.lastpage && J > f.lastpage || f.lastpage == 1 || J === f.page && J === f.lastpage)) if (g.hDiv.loading) g.timer = setTimeout(g.populateVisible, f.scrollTimeout); else {
                                    f.page = J;
                                    if (L) {
                ...
                if (this.tagName.toUpperCase() != "TABLE") alert("Element is not a table"); else {
                    ...
                    if (this.p.colNames.length !== this.p.colModel.length) alert(a.jgrid.errors.model); else {
                        ...
                        var o = function(u, t) {
                            ...
                            if (t === 0) J += "width: " + g.headers[u].width + "px;"; else if (I.cellattr && a.isFunction(I.cellattr)) if ((u = I.cellattr.call(b, D, w, z, I, P)) && typeof u === "string") {
                            ...
                            if (b.p.deepempty) a("#" + a.jgrid.jqID(b.p.id) + " tbody:first tr:gt(0)").remove(); else {
                            ...
                            if (u) {
                                ...
                                if (b.p.gridview === true) {
                                    ...
                                    if (b.p.grouping) a(b).jqGrid("groupingRender", za, b.p.colModel.length); else b.p.treeGrid === true && N > 0 ? a(b.rows[N]).after($.join("")) : a("#" + a.jgrid.jqID(b.p.id) + " tbody:first").append($.join(""));
                                }
                                if (b.p.subGrid === true) try {
                            ...
                            if (a.isArray(b.p.data)) {
                                ...
                                if (b.p.treeGrid) a(b).jqGrid("SortTree", t, b.p.sortorder, z[t].stype, z[t].srcfmt); else {
                                    var L = {
                                        eq: function(N) {
                                            return N.equals;
                                        },
                            ...
                            if (!b.grid.hDiv.loading) {
                                ...
                                if (a.isFunction(b.p.datatype)) b.p.datatype.call(b, b.p.postData, "load_" + b.p.id); else {
                        ...
                        l = function(u, t) {
                            var w = "", z = "<table cellspacing='0' cellpadding='0' border='0' style='table-layout:auto;' class='ui-pg-table'><tbody><tr>", D = "", P, I, W, J, O = function(L) {
                                var K;
                            ...
                            if (b.p.pgbuttons === true) {
                                a(".ui-pg-button", "#" + P).hover(function() {
                                    if (a(this).hasClass("ui-state-disabled")) this.style.cursor = "default"; else {
                                ...
                                a("#first" + a.jgrid.jqID(t) + ", #prev" + a.jgrid.jqID(t) + ", #next" + a.jgrid.jqID(t) + ", #last" + a.jgrid.jqID(t)).click(function() {
                                    ...
                                    if (K === 0 || K === 1) ha = ea = ga = ja = false; else if (K > 1 && L >= 1) if (L === 1) ga = ja = false; else {
                        ...
                        var qa = function(u, t, w, z) {
                            if (b.p.colModel[t].sortable) if (!(b.p.savedRow.length > 0)) {
                                if (!w) {
                                    if (b.p.lastsort == t) if (b.p.sortorder == "asc") b.p.sortorder = "desc"; else {
                                ...
                                if (b.p.datatype == "local") b.p.deselectAfterSort && a(b).jqGrid("resetSelection"); else {
                                    b.p.selrow = null;
                        ...
                        a(b).before(g.hDiv).click(function(u) {
                            ...
                            if (w === true) {
                                if (b.p.cellEdit === true) if (b.p.multiselect && t) a(b).jqGrid("setSelection", Q[0].id, true); else {
                                    ba = Q[0].rowIndex;
                                    ta = a.jgrid.getCellIndex(M);
                                    try {
                                        a(b).jqGrid("editCell", ba, ta, true);
                                    } catch (z) {}
                                } else if (b.p.multikey) if (u[b.p.multikey]) a(b).jqGrid("setSelection", Q[0].id, true); else {
                        ...
                        if (b.p.caption) {
                            ...
                            if (b.p.hidegrid === true) {
                                a(".ui-jqgrid-titlebar-close", g.cDiv).click(function(u) {
                                    var t = a.isFunction(b.p.onHeaderClick), w = ".ui-jqgrid-bdiv, .ui-jqgrid-hdiv, .ui-jqgrid-pager, .ui-jqgrid-sdiv", z, D = this;
                        ...
                        b.updatepager = function(u, t) {
                            var w, z, D, P, I, W, J, O = "", L = b.p.pager ? "_" + a.jgrid.jqID(b.p.pager.substr(1)) : "", K = b.p.toppager ? "_" + b.p.toppager.substr(1) : "";
                            ...
                            if (O) {
                                ...
                                if (b.p.viewrecords) if (b.p.reccount === 0) a(".ui-paging-info", O).html(b.p.emptyrecords); else {
                                    P = D + 1;
                                    W = b.p.records;
                                    if (a.fmatter) {
    ...
    a.jgrid.extend({
        ...
        setSelection: function(d, e) {
            return this.each(function() {
                function c(b) {
                    ...
                    if (n + b >= m + l) a(f.grid.bDiv)[0].scrollTop = n - (m + l) + b + l; else if (n < m + l) if (n < l) a(f.grid.bDiv)[0].scrollTop = n;
                }
                var f = this, g, h, j;
                if (d !== undefined) {
        ...
        setRowData: function(d, e, c) {
            ...
            this.each(function() {
                ...
                if (g) if (l === "string") a(m).addClass(c); else l === "object" && a(m).css(c);
            });
            return g;
        },
        addRowData: function(d, e, c, f) {
            ...
            if (e) {
                ...
                this.each(function() {
                    ...
                    if (!v) if (typeof d != "undefined") d += ""; else {
                        d = a.jgrid.randId();
        ...
        clearGridData: function(d) {
            return this.each(function() {
                if (this.grid) {
                    ...
                    if (this.p.deepempty) a("#" + a.jgrid.jqID(this.p.id) + " tbody:first tr:gt(0)").remove(); else {
        ...
        bindKeys: function(d) {
            ...
            return this.each(function() {
                ...
                a(c).keydown(function(f) {
                    var g = a(c).find("tr[tabindex=0]")[0], h, j, b, m = c.p.treeReader.expanded_field;
                    if (g) {
                        b = c.p._index[g.id];
                ...
                if (!this.ftoolbar) {
                    var f = function() {
                        ...
                        if (d.stringResult === true || c.p.datatype == "local") {
                            var o = '{"groupOp":"' + d.groupOp + '","rules":[', v = 0;
                        ...
                        if (this.search) switch (this.stype) {
                          case "select":
                            if (n = this.surl || l.dataUrl) a.ajax(a.extend({
                                ...
                                var k;
                                if (j.searchoptions && j.searchoptions.value) k = j.searchoptions.value; else if (j.editoptions && j.editoptions.value) k = j.editoptions.value;
                                if (k) {
...
(function(a) {
    ...
    a.jqm = {
        ...
        close: function(n) {
            ...
            if (n.c.onHide) n.c.onHide(n); else {
                n.w.hide();
                n.o && n.o.remove();
            }
            return g;
    ...
    var d = 0, e = a.jqm.hash, c = [], f = a.browser.msie && a.browser.version == "6.0", g = false, h = function(n) {
        ...
        (n = !a(n.target).parents(".jqmID" + k.s)[0]) && j(k);
        return !n;
    }, l = function(n, k, p) {
...
(function(a) {
    ...
    var d = a.jqDnR, e = d.dnr, c = d.e, f, g = function(j, b, m, l) {
...
var xmlJsonClass = {
    ...
    json2xml: function(a, d) {
        var e = function(g, h, j) {
            ...
            if (g instanceof Array) if (g.length === 0) b += j + "<" + h + ">__EMPTY_ARRAY_</" + h + ">\n"; else {
                ...
                m = false;
                b += j + "<" + h;
                for (l in g) if (g.hasOwnProperty(l)) if (l.charAt(0) === "@") b += " " + l.substr(1) + '="' + g[l].toString() + '"'; else m = true;
                b += m ? ">" : "/>";
                if (m) {
                    for (l in g) if (g.hasOwnProperty(l)) if (l === "#text") b += g[l]; else if (l === "#cdata") b += "<![CDATA[" + g[l] + "]]>"; else if (l.charAt(0) !== "@") b += e(g[l], l, j + "	");
    ...
    toObj: function(a) {
        ...
        if (a.nodeType === 1) {
            ...
            if (a.firstChild) {
                var f = c = 0, g = false, h;
                for (h = a.firstChild; h; h = h.nextSibling) if (h.nodeType === 1) g = true; else if (h.nodeType === 3 && h.nodeValue.match(/[^ \f\n\r\t\v]/)) c += 1; else if (h.nodeType === 4) f += 1;
                if (g) if (c < 2 && f < 2) {
                    this.removeWhite(a);
                    for (h = a.firstChild; h; h = h.nextSibling) if (h.nodeType === 3) d["#text"] = this.escape(h.nodeValue); else if (h.nodeType === 4) if (e.test(h.nodeValue)) d[h.nodeName] = [ d[h.nodeName], h.nodeValue ]; else d["#cdata"] = this.escape(h.nodeValue); else if (d[h.nodeName]) if (d[h.nodeName] instanceof Array) d[h.nodeName][d[h.nodeName].length] = this.toObj(h); else d[h.nodeName] = [ d[h.nodeName], this.toObj(h) ]; else d[h.nodeName] = this.toObj(h);
                } else if (a.attributes.length) d["#text"] = this.escape(this.innerXml(a)); else d = this.escape(this.innerXml(a)); else if (c) if (a.attributes.length) d["#text"] = this.escape(this.innerXml(a)); else {
                    d = this.escape(this.innerXml(a));
                    if (d === "__EMPTY_ARRAY_") d = "[]"; else if (d === "__EMPTY_STRING_") d = "";
        ...
        } else if (a.nodeType === 9) d = this.toObj(a.documentElement); else alert("unhandled node type: " + a.nodeType);
        return d;
    },
    ...
    innerXml: function(a) {
        var d = "";
        if ("innerHTML" in a) d = a.innerHTML; else {
            var e = function(c) {
                var f = "", g;
                if (c.nodeType === 1) {
                    f += "<" + c.nodeName;
                ...
                } else if (c.nodeType === 3) f += c.nodeValue; else if (c.nodeType === 4) f += "<![CDATA[" + c.nodeValue + "]]>";
                return f;
            };
...
(function(a) {
    ...
    a.extend(a.fmatter, {
        ...
        isEmpty: function(d) {
            if (!this.isString(d) && this.isValue(d)) return false; else if (!this.isValue(d)) return true;
            d = a.trim(d).replace(/\&nbsp\;/gi, "").replace(/\&#160\;/gi, "");
            return d === "";
        }
    });
    ...
    a.fmatter.util = {
        ...
        DateFormat: function(d, e, c, f) {
            var g = /^\/Date\((([-+])?[0-9]+)(([-+])([0-9]{2})([0-9]{2}))?\)\/$/, h = typeof e === "string" ? e.match(g) : null;
            g = function(s, x) {
                s = String(s);
            ...
            if (e.constructor === Number) {
                ...
                b = new Date(e);
            } else if (e.constructor === Date) b = e; else if (h !== null) {
                ...
                b = j.y;
                if (b >= 70 && b <= 99) j.y = 1900 + j.y; else if (b >= 0 && b <= 69) j.y = 2e3 + j.y;
    ...
    a.fn.fmatter.select = function(d, e) {
        ...
        if (c) {
            ...
            if (a.fmatter.isString(c)) for (var b = c.split(";"), m = 0, l = 0; l < b.length; l++) {
                j = b[l].split(":");
                if (j.length > 2) j[1] = jQuery.map(j, function(n, k) {
                    if (k > 0) return n;
                }).join(":");
                if (g) {
    ...
    a.unformat = function(d, e, c, f) {
        var g, h = e.colModel.formatter, j = e.colModel.formatoptions || {}, b = /([\.\*\_\'\(\)\{\}\+\?\\])/g, m = e.colModel.unformat || a.fn.fmatter[h] && a.fn.fmatter[h].unformat;
        if (typeof m !== "undefined" && a.isFunction(m)) g = m(a(d).text(), e, d); else if (!a.fmatter.isUndefined(h) && a.fmatter.isString(h)) {
            g = a.jgrid.formatter || {};
            switch (h) {
              case "integer":
...
(function(a) {
    a.extend(a.jgrid, {
        ...
        hideModal: function(d, e) {
            ...
            if (a.fn.jqm && e.jqm === true) a(d).attr("aria-hidden", "true").jqmHide(); else {
                if (e.gb !== "") try {
        ...
        viewModal: function(d, e) {
            ...
            if (a.fn.jqm && e.jqm === true) e.jqM ? a(d).attr("aria-hidden", "false").jqm(e).jqmShow() : a(d).attr("aria-hidden", "false").jqmShow(); else {
                if (e.gbox !== "") {
        ...
        createEl: function(d, e, c, f, g) {
            function h(p, o) {
                ...
                o.dataEvents && a.each(o.dataEvents, function() {
            ...
            switch (d) {
              ...
              case "select":
                ...
                if (typeof e.dataUrl != "undefined") a.ajax(a.extend({
                    ...
                    success: function(p) {
                        var o = [], v = this.elem, q = this.vl, r = a.extend({}, this.options), s = r.multiple === true;
        ...
        return this.each(function() {
            if (!this.filter) {
                ...
                if (h) {
                    for (g = 0; g < h; g++) {
                        j = this.p.columns[g];
                        if (j.stype) j.inputtype = j.stype; else if (!j.inputtype) j.inputtype = "text";
                        if (j.sorttype) j.searchtype = j.sorttype; else if (!j.searchtype) j.searchtype = "string";
                    ...
                    var m = function(l, n) {
                        var k = [ true, "" ];
                        if (a.isFunction(n.searchrules)) k = n.searchrules(l, n); else if (a.jgrid && a.jgrid.checkValues) try {
                    ...
                    this.createTableForGroup = function(l, n) {
                        ...
                        if (this.p.ruleButtons === true) {
                            ...
                            r.append(v).bind("change", function() {
                                l.groupOp = a(r).val();
                                k.onchange();
                            });
                        }
    ...
    a.jgrid.extend({
        searchGrid: function(d) {
            ...
            return this.each(function() {
                ...
                if (c.grid) {
                    ...
                    if (a("#" + h.themodal).html() !== null) e(); else {
                        ...
                        if (!j && o || d.multipleSearch === false) {
                            var r = "eq";
                            if (q >= 0 && m[q].searchoptions && m[q].searchoptions.sopt) r = m[q].searchoptions.sopt[0]; else if (d.sopt && d.sopt.length) r = d.sopt[0];
                            j = {
                                groupOp: "AND",
                                rules: [ {
                                    field: o,
                        ...
                        a("#" + f + "_reset").bind("click", function() {
                            var s = {}, x = a("#" + f);
                            c.p.search = false;
                            if (d.multipleSearch === false) s[d.sField] = s[d.sValue] = s[d.sOper] = ""; else s[d.sFilter] = "";
                            x[0].resetFilter();
            ...
            return this.each(function() {
                    ...
                    a("#" + r + " > tbody > tr > td > .FormElement").each(function() {
                        ...
                        if (E.length) {
                            ...
                            switch (a(this).get(0).type) {
                              case "checkbox":
                                if (a(this).attr("checked")) C[this.name] = a(this).val(); else {
                ...
                function g(E, H, U, M) {
                    ...
                    a(H.p.colModel).each(function(wa) {
                        ...
                        if (Q !== "cb" && Q !== "subgrid" && this.editable === true && Q !== "rn") {
                            if (ba === false) V = ""; else if (Q == H.p.ExpandColumn && H.p.treeGrid === true) V = a("td:eq(" + wa + ")", H.rows[ba]).text(); else {
                                try {
                            ...
                            a("td", ma).each(function(ba) {
                                ...
                                if (M !== "cb" && M !== "subgrid" && M !== "rn" && fa[ba].editable === true) {
                                    ...
                                    switch (fa[ba].edittype) {
                                      ...
                                      case "custom":
                                        try {
                                            if (fa[ba].editoptions && a.isFunction(fa[ba].editoptions.custom_value)) fa[ba].editoptions.custom_value(a("#" + M, "#" + U), "set", Y); else throw "e1";
                                        } catch (wa) {
                ...
                function j() {
                    ...
                    if (H[0] && !c.processing) {
                        ...
                        if (C[Y] != M.addoper) C[Q] = C[o.p.id + "_id"]; else if (C[Q] === undefined) C[Q] = C[o.p.id + "_id"];
                        delete C[o.p.id + "_id"];
                            ...
                            complete: function(la, fa) {
                                ...
                                if (H[0] === false) {
                                    ...
                                    if (C[Y] == M.addoper) {
                                        ...
                                        C[Q] = H[2];
                                        if (c.closeAfterAdd) {
                                            if (c.reloadAfterSubmit) a(o).trigger("reloadGrid"); else if (o.p.treeGrid === true) a(o).jqGrid("addChildNode", H[2], da, C); else {
                                            ...
                                            if (c.reloadAfterSubmit) a(o).trigger("reloadGrid"); else o.p.treeGrid === true ? a(o).jqGrid("addChildNode", H[2], da, C) : a(o).jqGrid("addRowData", H[2], C, e.addedrow);
                                            h("_empty", o, q);
                        ...
                        if (!U.url && !c.useDataProxy) if (a.isFunction(o.p.dataProxy)) c.useDataProxy = true; else {
                            H[0] = false;
                ...
                if (o.grid && d) {
                    var v = o.p.id, q = "FrmGrid_" + v, r = "TblGrid_" + v, s = {
                        ...
                        scrollelm: q
                    }, x = a.isFunction(c.beforeShowForm) ? c.beforeShowForm : false, A = a.isFunction(c.afterShowForm) ? c.afterShowForm : false, B = a.isFunction(c.beforeInitData) ? c.beforeInitData : false, F = a.isFunction(c.onInitializeForm) ? c.onInitializeForm : false, y = true, G = 1, S = 0, C, R, ca, ka;
                    if (d === "new") {
                        d = "_empty";
                    ...
                    if (a("#" + s.themodal).html() !== null) {
                        ...
                        a("#sData", "#" + r + "_2").click(function() {
                            ...
                            f();
                            m();
                            if (C[o.p.id + "_id"] == "_empty") j(); else if (e.checkOnSubmit === true) {
                                ca = a.extend({}, C, R);
                                if (ka = b(ca, c._savedData)) {
                                    a("#" + q).data("disabled", true);
                                    a(".confirm", "#" + s.themodal).show();
            ...
            return this.each(function() {
                    ...
                    a(G.p.colModel).each(function(Z) {
                        ...
                        if (R !== "cb" && R !== "subgrid" && R !== "rn" && Q) {
                            ...
                            var da = a.extend({}, {
                                rowabove: false,
                                rowcontent: ""
                            }, this.formoptions || {}), V = parseInt(da.rowpos, 10) || ia + 1, la = parseInt((parseInt(da.colpos, 10) || 1) * 2, 10);
                            if (da.rowabove) {
                ...
                if (b.grid && d) {
                    ...
                    var m = b.p.id, l = "ViewGrid_" + m, n = "ViewTbl_" + m, k = {
                        ...
                        scrollelm: l
                    }, p = a.isFunction(e.beforeInitData) ? e.beforeInitData : false, o = true, v = 1, q = 0;
        ...
        delGridRow: function(d, e) {
            ...
            return this.each(function() {
                var f = this;
                if (f.grid) if (d) {
                    var g = a.isFunction(e.beforeShowForm), h = a.isFunction(e.afterShowForm), j = a.isFunction(e.beforeInitData) ? e.beforeInitData : false, b = f.p.id, m = {}, l = true, n = "DelTbl_" + b, k, p, o, v, q = {
                        themodal: "delmod" + b,
                        modalhead: "delhd" + b,
                    ...
                    if (a("#" + q.themodal).html() !== null) {
                        ...
                        a("#dData", "#" + n + "_2").click(function() {
                            ...
                            if (s[0] && !c.processing) {
                                ...
                                var A = a.extend({
                                    ...
                                    complete: function(B, F) {
                                        ...
                                        if (s[0] === false) {
                                            ...
                                            if (c.reloadAfterSubmit && f.p.datatype != "local") a(f).trigger("reloadGrid"); else {
                                                var y = [];
                                                y = x.split(",");
                                ...
                                if (!A.url && !c.useDataProxy) if (a.isFunction(f.p.dataProxy)) c.useDataProxy = true; else {
                                    s[0] = false;
            ...
            return this.each(function() {
                if (!this.nav) {
                    ...
                    if (!(!m.grid || typeof d != "string")) {
                        ...
                        for (n = 0; n < l; n++) {
                            var p = a("<table cellspacing='0' cellpadding='0' border='0' class='ui-pg-table navtable' style='float:left;table-layout:auto;'><tbody><tr></tr></tbody></table>"), o, v;
                            if (n === 0) {
                                o = d;
                                v = m.p.id;
                                if (o == m.p.toppager) {
                            ...
                            if (e.edit) {
                                ...
                                a(k, p).attr({
                                    ...
                                    if (!a(this).hasClass("ui-state-disabled")) {
                                        var q = m.p.selrow;
                                        if (q) a.isFunction(e.editfunc) ? e.editfunc(q) : a(m).jqGrid("editGridRow", q, c); else {
                            ...
                            if (e.view) {
                                ...
                                a(k, p).attr({
                                    ...
                                    if (!a(this).hasClass("ui-state-disabled")) {
                                        var q = m.p.selrow;
                                        if (q) a.isFunction(e.viewfunc) ? e.viewfunc(q) : a(m).jqGrid("viewGridRow", q, j); else {
                                            a.jgrid.viewModal("#" + b.themodal, {
                                                gbox: "#gbox_" + m.p.id,
                                                jqm: true
                                            });
                            ...
                            if (e.del) {
                                ...
                                a(k, p).attr({
                                    ...
                                    if (!a(this).hasClass("ui-state-disabled")) {
                                        ...
                                        if (q) "function" == typeof e.delfunc ? e.delfunc(q) : a(m).jqGrid("delGridRow", q, g); else {
                                            a.jgrid.viewModal("#" + b.themodal, {
                                                gbox: "#gbox_" + m.p.id,
                                                jqm: true
                                            });
                    ...
                    if (!(g == "subgrid" || g == "cb" || g == "rn")) {
                        ...
                        if (b.editable === true && c === true && !j.hasClass("not-editable-cell")) {
                            ...
                            a("input, select, textarea", j).bind("keydown", function(k) {
                                ...
                                if (k.keyCode == 9) if (f.grid.hDiv.loading) return false; else k.shiftKey ? a(f).jqGrid("prevCell", d, e) : a(f).jqGrid("nextCell", d, e);
                                k.stopPropagation();
                            });
            ...
            return this.each(function() {
                function d(j, b, m) {
                    ...
                    if (m == "h") {
                        ...
                        if (c.rows[j].cells[b].offsetLeft + c.rows[j].cells[b].clientWidth >= m + parseInt(l, 10)) a(c.grid.bDiv)[0].scrollLeft = a(c.grid.bDiv)[0].scrollLeft + c.rows[j].cells[b].clientWidth; else if (n < l) a(c.grid.bDiv)[0].scrollLeft = a(c.grid.bDiv)[0].scrollLeft - c.rows[j].cells[b].clientWidth;
                    }
                }
                function e(j, b) {
                    var m, l;
                ...
                if (!(!c.grid || c.p.cellEdit !== true)) {
                    ...
                    a("#" + c.p.knv).focus().keydown(function(j) {
                        h = j.keyCode;
                        if (c.p.direction == "rtl") if (h == 37) h = 39; else if (h == 39) h = 37;
                        switch (h) {
                          case 38:
                            if (c.p.iRow - 1 > 0) {
            ...
            return this.each(function() {
                ...
                if (c.grid) {
                    var f = function(q, r, s) {
                        ...
                        var s, x, A, B, F, y = a("<table cellspacing='0' cellpadding='0' border='0'><tbody></tbody></table>"), G = a("<tr></tr>");
                        for (x = 0; x < c.p.subGridModel[0].name.length; x++) {
                            s = a("<th class='ui-state-default ui-th-subgrid ui-th-column ui-th-" + c.p.direction + "'></th>");
                            a(s).html(c.p.subGridModel[0].name[x]);
                            a(s).width(c.p.subGridModel[0].width[x]);
                        ...
                        if (c.p.subGridModel[0].params) for (A = 0; A < c.p.subGridModel[0].params.length; A++) for (x = 0; x < c.p.colModel.length; x++) if (c.p.colModel[x].name == c.p.subGridModel[0].params[A]) s[c.p.colModel[x].name] = a("td:eq(" + x + ")", q).text().replace(/\&#160\;/gi, "");
                    ...
                    for (;v < o; ) {
                        a(c.rows[v]).hasClass("jqgrow") && a(c.rows[v].cells[d]).bind("click", function() {
    ...
    a.jgrid.extend({
            ...
            return this.each(function() {
                ...
                if (d.p.treeGrid) {
                    ...
                    if (d.p.treeGridModel == "nested") d.p.treeReader = a.extend({
                        ...
                        loaded: "loaded",
                        icon_field: "icon"
                    }, d.p.treeReader); else if (d.p.treeGridModel == "adjacency") d.p.treeReader = a.extend({
                        level_field: "level",
        ...
        getNodeParent: function(d) {
            ...
            this.each(function() {
                if (this.grid && this.p.treeGrid) switch (this.p.treeGridModel) {
                  case "nested":
                    var c = this.p.treeReader.left_field, f = this.p.treeReader.right_field, g = this.p.treeReader.level_field, h = parseInt(d[c], 10), j = parseInt(d[f], 10), b = parseInt(d[g], 10);
        ...
        getFullTreeNode: function(d) {
            ...
            this.each(function() {
                ...
                if (this.grid && this.p.treeGrid) switch (this.p.treeGridModel) {
                  case "nested":
                    var f = this.p.treeReader.left_field, g = this.p.treeReader.right_field, h = this.p.treeReader.level_field, j = parseInt(d[f], 10), b = parseInt(d[g], 10), m = parseInt(d[h], 10);
                    a(this.p.data).each(function() {
        ...
        delTreeNode: function(d) {
            return this.each(function() {
                var e = this.p.localReader.id, c = this.p.treeReader.left_field, f = this.p.treeReader.right_field, g, h, j;
                if (this.grid && this.p.treeGrid) {
    ...
    a.jgrid.extend({
        ...
        groupingPrepare: function(d, e, c, f) {
            this.each(function() {
                ...
                if (c.hasOwnProperty(g)) c[g].push(d); else {
                    c[g] = [];
                    c[g].push(d);
                ...
                a.each(f.sortitems[0], function(k, p) {
                    ...
                    if (f.groupSummary[0]) {
                        ...
                        for (var q = c.p.colModel, r, s = d[p].length, x = 0; x < e; x++) {
                            var A = "<td " + c.formatCol(x, 1, "") + ">&#160;</td>", B = "{0}";
                            a.each(v, function() {
                                if (this.nm == q[x].name) {
        ...
        groupingRemove: function(d) {
            return this.each(function() {
                ...
                if (d === true) {
                    for (var e = this.p.groupingView, c = 0; c < e.groupField.length; c++) !e.groupColumnShow[c] && e.visibiltyOnNextGrouping[c] && a(this).jqGrid("showCol", e.groupField);
    ...
    a.jgrid.extend({
        sortableColumns: function(e) {
            return this.each(function() {
                ...
                if (f.p.sortable.options) a.extend(g, f.p.sortable.options); else if (a.isFunction(f.p.sortable)) f.p.sortable = {
                    update: f.p.sortable
                };
                if (g.start) {
                    var h = g.start;
        ...
        columnChooser: function(e) {
            ...
            if (!a("#colchooser_" + f[0].p.id).length) {
                ...
                var j = f.jqGrid("getGridParam", "colModel"), b = f.jqGrid("getGridParam", "colNames"), m = {}, l = [];
                h.empty();
                a.each(j, function(k) {
                    m[this.name] = k;
        ...
        gridDnD: function(e) {
            return this.each(function() {
                ...
                if (f.grid) if (!f.p.treeGrid) if (a.fn.draggable && a.fn.droppable) {
                    ...
                    if (typeof e == "string" && e == "updateDnD" && f.p.jqgdnd === true) c(); else {
                        e = a.extend({
                            drag: function(h) {
                                return a.extend({
                                    start: function(j, b) {
                                ...
                                return a.extend({
                                    ...
                                    drop: function(j, b) {
                                        if (a(b.draggable).hasClass("jqgrow")) {
                                            ...
                                            if (b.helper.dropped) {
                                                var q;
                                                if (h.autoid) if (a.isFunction(h.autoid)) q = h.autoid.call(this, m); else {
